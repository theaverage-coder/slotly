        ...
        <View style={styles.screenContainer}>
            <View style={styles.textContainer}>
                <View style={styles.frame51}>
                    <View style={styles.checkCircle}>
                        <Svg style={styles.vector} width="37" height="38" viewBox="0 0 37 38" fill="none" >
                            <Path d="M18.4999 0.962891C14.9324 0.962891 11.4451 2.02077 8.47881 4.00276C5.51256 5.98474 3.20065 8.80182 1.83543 12.0977C0.470218 15.3937 0.113015 19.0204 0.808996 22.5193C1.50498 26.0183 3.22288 29.2322 5.74547 31.7548C8.26806 34.2774 11.482 35.9953 14.981 36.6913C18.4799 37.3873 22.1066 37.0301 25.4026 35.6649C28.6985 34.2997 31.5156 31.9877 33.4975 29.0215C35.4795 26.0552 36.5374 22.5679 36.5374 19.0004C36.5324 14.2181 34.6304 9.63312 31.2488 6.25153C27.8672 2.86994 23.2822 0.967941 18.4999 0.962891ZM26.4191 15.8195L16.7066 25.532C16.5777 25.6611 16.4247 25.7634 16.2562 25.8332C16.0878 25.903 15.9072 25.939 15.7249 25.939C15.5426 25.939 15.362 25.903 15.1936 25.8332C15.0251 25.7634 14.8721 25.6611 14.7433 25.532L10.5808 21.3695C10.3204 21.1092 10.1741 20.7561 10.1741 20.3879C10.1741 20.0197 10.3204 19.6666 10.5808 19.4062C10.8411 19.1459 11.1942 18.9996 11.5624 18.9996C11.9306 18.9996 12.2837 19.1459 12.5441 19.4062L15.7249 22.5888L24.4558 13.8562C24.5847 13.7273 24.7377 13.6251 24.9061 13.5553C25.0746 13.4855 25.2551 13.4496 25.4374 13.4496C25.6197 13.4496 25.8002 13.4855 25.9687 13.5553C26.1371 13.6251 26.2902 13.7273 26.4191 13.8562C26.548 13.9851 26.6502 14.1382 26.72 14.3066C26.7898 14.4751 26.8257 14.6556 26.8257 14.8379C26.8257 15.0202 26.7898 15.2007 26.72 15.3692C26.6502 15.5376 26.548 15.6906 26.4191 15.8195Z" fill="#32C548" />
                        </Svg>
            ...
            <View style={styles.slotlyFourLogos}>
                ...
                <View style={styles.frame138}>
                    <Svg style={styles.Group12} width="139" height="139" viewBox="0 0 139 139" fill="none" >
                ...
                <View style={styles.frame139}>
                    <Svg style={styles.Group12} width="110" height="110" viewBox="0 0 110 110" fill="none" >
                ...
                <View style={styles.frame140}>
                    <Svg style={styles.Group12} width="100" height="123" viewBox="0 0 100 123" fill="none" >
...
const styles = StyleSheet.create({
    ...
    frame51: {
        ...
        alignItems: "center",
        justifyContent: "center",
        columnGap: 14.800000190734863,
        paddingHorizontal: 22.200000762939453,
        paddingVertical: 14.800000190734863,
        borderRadius: 59.20000076293945
    },
    checkCircle: {
        position: "relative",
        flexShrink: 0,
