...
export default function OnboardingStepOne() {
    ...
    return (
        <View style={styles.screenContainer}>
            <View style={styles.frame162}>
                <Link href="onboarding/onboardingDefault" style={styles.backArrow}>
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.inputContainer}>
                        <View style={styles.topText}>
                            ...
                            <View style={styles.stepsText}>
                                <Text style={styles.letsGettoKnowYou}>
                                    {`Let’s Get to Know You!`}
                                </Text>
                                <Text style={styles.justyournamenoessayswepromise}>
                                    {`Just your name, no essays, we promise.`}
                                </Text>
                            </View>
                        </View>
                    ...
                    <Link href="onboarding/onboardingStepTwo" style={styles.continue}>
