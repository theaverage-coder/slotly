    ...
    return (
        <View style={styles.screenContainer}>
            <View style={styles.frame165}>
                <Link href='onboarding/onboardingStepThree' style={styles.arrowBack}>
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.inputContainer}>
                        <View style={styles.topText}>
                            ...
                            <View style={styles.stepsText}>
                                <Text style={styles.chooseYourRole}>
                                    {`Choose Your Role!`}
                                </Text>
                                <Text style={styles.wellpersonalizeyourexperiencebasedonyourrole}>
                        ...
                        <View style={styles.inputRole}>
                            <View style={styles.frame156}>
                                <Pressable onPress={() => setIsStudent(true)} style={[styles.roleOption, isStudent && styles.clickedRoleOption]}>
                                    ...
                                    <View style={styles.frame154}>
                                        ...
                                        <Svg style={styles.ellipse8} width="20" height="21" viewBox="0 0 20 21" fill="none" >
                                            <Circle cx="10" cy="10.2305" r="9.5" stroke="white" />
                                        </Svg>

                                    </View>
                                </Pressable>
                                <Pressable onPress={() => setIsStudent(false)} style={[styles.roleOption, !isStudent && styles.clickedRoleOption]} /*frame153 */>
                                    <Text style={styles._myVar}>
                                        {`🧑‍🏫`}
                                    </Text>
                                    <View style={styles._frame154}>
                    ...
                    <Link href='onboarding/onboardingDone' style={styles.continue}>
...
const styles = StyleSheet.create({
    ...
    wellpersonalizeyourexperiencebasedonyourrole: {
        position: "relative",
        alignSelf: "stretch",
        flexShrink: 0,
        textAlign: "left",
