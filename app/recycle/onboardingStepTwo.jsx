...
export default function OnboardingStepTwo({ }) {
    ...
    return (
        <View style={styles.screenContainer}>
            <View style={styles.frame163}>
                <Link href="onboarding/onboardingStepOne" style={styles.backArrow}>
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.inputContainer}>
                        <View style={styles.topText}>
                            ...
                            <View style={styles.stepsText}>
                                ...
                                <Text style={styles.youllneedthistologinandreceivebookingupdates}>
                                    {`You’ll need this to log in and receive booking updates.`}
                                </Text>
                            </View>
                        </View>
                        <View style={styles.inputEmail1}>
                            <View style={styles.inputEmail2}>
                                <TextInput
                    ...
                    <Link href="onboarding/onboardingStepThree" style={styles.continue}>
...
const styles = StyleSheet.create({
    ...
    youllneedthistologinandreceivebookingupdates: {
        position: "relative",
        alignSelf: "stretch",
        flexShrink: 0,
        textAlign: "left",
