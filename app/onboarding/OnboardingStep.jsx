...
export default function OnboardingStep({ navigation, prevPagePath, number, header, description }) {
    return (
        <View style={styles.componentContainer}>
            <Button onPress={() => navigation.navigate({ prevPagePath })} style={[styles.containerItem, styles.backButton]}>
                <Svg style={styles.backArrow} width="40" height="40" viewBox="0 0 40 40" fill="none" >
            ...
            <View style={[styles.containerItem, styles.stepText]}>
